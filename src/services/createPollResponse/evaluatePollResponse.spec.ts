...
import { createPollResponse, createPollResponseOptions } from './createPollResponse';
...
describe('evaluatePollResponse', () => {
  ...
  beforeEach(() => {
    ...
    // Setup default mocks
    (createPollResponse as unknown as ReturnType<typeof vi.fn>).mockResolvedValue({ response_id: mockResponseId });
    (createPollResponseOptions as unknown as ReturnType<typeof vi.fn>).mockResolvedValue(undefined);
    (getPollOptions as unknown as ReturnType<typeof vi.fn>).mockResolvedValue(mockPollOptions);
  });
  ...
  describe('Single choice polls', () => {
    ...
    it('should return correct result when the correct option is selected', async () => {
    ...
    it('should return incorrect result when a wrong option is selected', async () => {
